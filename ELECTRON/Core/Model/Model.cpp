...
void Core::Model::loadModel(std::string const& path)
{
...
Core::Mesh Core::Model::processMesh(aiMesh* mesh, const aiScene* scene)
{
    // data to fill
...
std::vector<Core::Texture> Core::Model::loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName)
{
    std::vector<Core::Texture> textures;
...
unsigned int Core::Model::TextureFromFile(const char* path, const std::string& directory, bool gamma)
{
...
//
//
//std::vector<Texture> Core::Model::loadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName)
//{
//	std::vector<Texture> textures;
//	for (unsigned int i = 0; i < mat->GetTextureCount(type); i++)
//	{
